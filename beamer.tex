...
%========================
\section*{Overview}
\begin{frame}[t]{How to use this style}{And a few short examples}
\begin{itemize}
...
\begin{frame}[t,leftlogo]{Single-column text}
...
\begin{itemize}
    ...
    \begin{itemize} 
       \item directly to the frame after the \verb|\begin{frame}| as \verb|\begin{frame}[t]{Frame title}|.
    ...
    \begin{itemize} 
       \item directly to the frame after the \verb|\begin{frame}[t]{Frame title}| as \verb|\begin{frame}[t]{Frame title}{Frame subtitle}|.
...
\begin{frame}[t]{Two-column layout}
...
\begin{frame}[t]{Text with figure}
\begin{columns}[T,onlytextwidth]
  ...
  \begin{figure}
    ...
    \fbox{\rule{0pt}{3cm}\rule{.9\linewidth}{0pt}}
...
\begin{frame}[t]{Blocks and emphasis}
...
\begin{frame}[t]{Full-width figure}
\begin{figure}
  \centering
  % \includegraphics[width=.9\linewidth]{path/to/figure}
  \setlength{\fboxsep}{0pt}%
  \fbox{\rule{0pt}{4cm}\rule{.9\linewidth}{0pt}}
